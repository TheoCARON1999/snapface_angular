...
export class App implements OnInit{
  ...
  ngOnInit(): void {
      this.faceSnaps = [new FaceSnapModel("oiseaux", 
      ...
      this.faceSnaps[0].setNameLocation('Brésil')
      this.faceSnaps[2].setNameLocation('Prague')
      this.faceSnaps[2].setMapLocation('https://www.google.com/maps/place/Clementinum/@50.08424,14.4097656,6842m/data=!3m1!1e3!4m6!3m5!1s0x470b94ef35324235:0xb234ae92107e0d9f!8m2!3d50.0865979!4d14.4160186!16zL20vMDU5dHk5?authuser=0&entry=ttu&g_ep=EgoyMDI1MTAxNC4wIKXMDSoASAFQAw%3D%3D')
      
      this.faceSnaps[1].value = 1708.45
      this.faceSnaps[2].value = 500
      this.faceSnaps[3].value = 103.77
  }
